...
*   브로커 정보: 브로커 프로세스별 포트와 각종 상태 정보를 출력한다. 각종 상태 정보에 대한 상세 설명은 큐브리드 메뉴얼의 브로커 상태 부분을 참고한다.
...
각 항목에 관한 보다 자세한 내용은 큐브리드 메뉴얼의 statdump 부분을 참고한다.
...
각 항목에 대한 보다 자세한 내용은 큐브리드 메뉴얼의 브로커 상태 부분을 참고한다.
