...
Greptile 규칙 검증용 임시 문서 (CA)
=======================================

이 문서는 Greptile 리뷰 규칙 동작을 확인하기 위한 임시 파일이다. 병합하지 않는다.

1. 한국어 외래어 표기 (ko-notation-auto)
------------------------------------------
...
2. 용어 통일과 띄어쓰기 (ko-term-unify-auto)
----------------------------------------------
...
3. 한국어 문맥 판단 항목 (ko-notation-manual)
-----------------------------------------------
...
4. 영문 표기 (en-notation-auto, en-notation-word)
---------------------------------------------------
...
7. 인코딩 표기 (encoding-notation-context)
--------------------------------------------
...
9. 문체 (ko-honorific-consistency)
-------------------------------------

이 값을 변경하면 서비스를 재시작해야 합니다.
자세한 내용은 다음 절에서 설명합니다.

10. 절차 안전성 (doc-procedure-safety)
----------------------------------------
